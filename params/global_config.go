...
var (
	...
	MaxBlockSize_global = 1500    // the block contains the maximum number of transactions
	InjectSpeed         = 4000    // the transaction inject speed
	TotalDataSize       = 4500000 // the total number of txs
