...
var (
	...
	InjectSpeed         = 1500   // the transaction inject speed
	TotalDataSize       = 600000 // the total number of txs
	BatchSize           = 1500   // supervisor read a batch of txs then send them, it should be larger than inject speed
	BrokerNum           = 100
	NodesInShard        = 4
	ShardNum            = 16
	IterNum_B2E         = 5
