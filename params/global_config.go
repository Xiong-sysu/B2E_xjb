...
var (
	...
	InjectSpeed         = 10000  // the transaction inject speed
	TotalDataSize       = 210000 // the total number of txs
	BatchSize           = 10000  // supervisor read a batch of txs then send them, it should be larger than inject speed
	BrokerNum           = 200
	NodesInShard        = 4
	ShardNum            = 6
	IterNum_B2E         = 5
